...
function Home() {
  ...
  const handleCommand = (data) => {
    if (!data) data = { type: "general", userInput: "", response: "Sorry, I couldn't get a response." };
    if (typeof data === "string") {
      try {
        data = JSON.parse(data);
      } catch {
        data = { type: "general", userInput: "", response: data || "Sorry, couldn't parse response." };
      }
    }
  ...
  useEffect(() => {
    ...
    recognition.onresult = async (e) => {
      ...
      if (transcript.toLowerCase().includes(userData.assistantName.toLowerCase())) {
        ...
        let data = await getAIResponse(transcript);

        // fallback
        if (!data) data = { type: "general", userInput: transcript, response: "Sorry, I couldn't get a response." };
        ...
        if (typeof data === "string") {
          try {
            ...
            data = { type: "general", userInput: transcript, response: data };
          }
        }
